...
instructions
		...
		LDR R12, LARGEST_VAL ; 0XFFFFFFFF
		ADD R13, R6, #1 ; Set R3 to 0x00000001
		
		;instr 11 to 20 (0B to 14)
    
		MUL R14, R12, R12 ; 0XFFFFFFFF * 0XFFFFFFFF = 0x00000001
		MUL R14, R13, R12 ; 0x00000001 * 0XFFFFFFFF = 0xFFFFFFFF
		MUL R14, R12, R13 ; 0xFFFFFFFF * 0X00000001 = 0xFFFFFFFF
		MUL R14, R6, R12 ; 0x00000000 * 0xFFFFFFFF = 0x00000000
    
		MLA R14, R12, R12, R11 ; 0xFFFFFFFF / 0xFFFFFFFF = 0x00000001 R 0
		MLA R14, R12, R13, R11 ; 0xFFFFFFFF / 0x00000001 = 0xFFFFFFFF R 0
		MLA R14, R13, R12, R11 ; 0x00000001 / 0xFFFFFFFF = 0x00000000 R 1
		MLA R14, R6, R12, R11 ; 0x00000000 / 0xFFFFFFFF = 0x00000000 R 0

		MUL R12, R5, R11            ;R12 = 250 x 100 = 25000;
		
		MLA R13, R12, R11, R11       ;R12 = 25000/100 = 250, R11 ignored
