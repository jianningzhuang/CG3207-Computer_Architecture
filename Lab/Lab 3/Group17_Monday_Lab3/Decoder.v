...
module Decoder(
    ...
    // Start is set when the instruction is a MUL or DIV
    // Start is true when Instr[27:22] is 0 and Instr[7:4] is 4'b1001
    assign Start = (Op == 2'b00) & (Funct[5:2] == 4'b0000) & (MCycleFunct == 4'b1001);
    
    // Instr[21] = 0 for MUL and Instr[21] = 1 for DIV
    // 2'b01 = unsigned multiplication, 2'b11 = unsigned division
