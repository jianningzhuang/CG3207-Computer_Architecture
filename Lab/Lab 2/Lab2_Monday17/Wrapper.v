...
initial begin
			...
			INSTR_MEM[4] = 32'hE59F5214; 
			INSTR_MEM[5] = 32'hE59F6200; 
			INSTR_MEM[6] = 32'hE59F720C; 
			INSTR_MEM[7] = 32'hE59F8208; 
			INSTR_MEM[8] = 32'hE59FB1FC; 
			INSTR_MEM[9] = 32'hE386C0FF; 
			INSTR_MEM[10] = 32'hE096D3CC; 
			INSTR_MEM[11] = 32'hE59FD1F4; 
			INSTR_MEM[12] = 32'hE09DC0AC; 
			INSTR_MEM[13] = 32'h600CC006; 
			INSTR_MEM[14] = 32'h415C000C; 
			INSTR_MEM[15] = 32'h017D008D; 
			INSTR_MEM[16] = 32'h2591C004; 
			INSTR_MEM[17] = 32'h2502C004; 
			INSTR_MEM[18] = 32'h225BB001; 
			INSTR_MEM[19] = 32'hAAFFFFF4; 
			INSTR_MEM[20] = 32'hEAFFFFFF; 
			INSTR_MEM[21] = 32'hE35500FA; 
			INSTR_MEM[22] = 32'hD59F61D0; 
			INSTR_MEM[23] = 32'hE35500E1; 
			INSTR_MEM[24] = 32'hC5846000; 
			INSTR_MEM[25] = 32'hE35500E1; 
			INSTR_MEM[26] = 32'hD59F61C4; 
			INSTR_MEM[27] = 32'hE35500C8; 
			INSTR_MEM[28] = 32'hC5846000; 
			INSTR_MEM[29] = 32'hE35500C8; 
			INSTR_MEM[30] = 32'hD59F61B8; 
			INSTR_MEM[31] = 32'hE35500AF; 
			INSTR_MEM[32] = 32'hC5846000; 
			INSTR_MEM[33] = 32'hE35500AF; 
			INSTR_MEM[34] = 32'hD59F618C; 
			INSTR_MEM[35] = 32'hD5846000; 
			INSTR_MEM[36] = 32'hE5936000; 
			INSTR_MEM[37] = 32'hE58F5764; 
			INSTR_MEM[38] = 32'hE3560004; 
			INSTR_MEM[39] = 32'h059F775C; 
			INSTR_MEM[40] = 32'hE3560001; 
			INSTR_MEM[41] = 32'h059F8754; 
			INSTR_MEM[42] = 32'hE3560005; 
			INSTR_MEM[43] = 32'h059F774C; 
			INSTR_MEM[44] = 32'h059F8748; 
			INSTR_MEM[45] = 32'hE2555001; 
			INSTR_MEM[46] = 32'h1AFFFFE5; 
			INSTR_MEM[47] = 32'hEAFFFFFF; 
			INSTR_MEM[48] = 32'hE5936000; 
			INSTR_MEM[49] = 32'hE58F5734; 
			INSTR_MEM[50] = 32'hE3560004; 
			INSTR_MEM[51] = 32'h059F772C; 
			INSTR_MEM[52] = 32'hE3560001; 
			INSTR_MEM[53] = 32'h059F8724; 
			INSTR_MEM[54] = 32'hE3560005; 
			INSTR_MEM[55] = 32'h059F771C; 
			INSTR_MEM[56] = 32'h059F8718; 
			INSTR_MEM[57] = 32'hE2855001; 
			INSTR_MEM[58] = 32'hE3550064; 
			INSTR_MEM[59] = 32'h1AFFFFF3; 
			INSTR_MEM[60] = 32'hEAFFFFFF; 
			INSTR_MEM[61] = 32'hE1570008; 
			INSTR_MEM[62] = 32'hC59F6140; 
			INSTR_MEM[63] = 32'hC5846000; 
			INSTR_MEM[64] = 32'hB59F6134; 
			INSTR_MEM[65] = 32'hB5846000; 
			INSTR_MEM[66] = 32'h059F6134; 
			INSTR_MEM[67] = 32'h05846000; 
			INSTR_MEM[68] = 32'hEAFFFFFF; 
			INSTR_MEM[69] = 32'hE5926000; 
			INSTR_MEM[70] = 32'hE5816000; 
			INSTR_MEM[71] = 32'hEAFFFFFC; 
			INSTR_MEM[72] = 32'hEAFFFFFE; 
			for(i = 73; i < 128; i = i+1) begin 
				INSTR_MEM[i] = 32'h0; 
			end
end
...
initial begin
			...
			DATA_CONST_MEM[11] = 32'h000000FA; 
			DATA_CONST_MEM[12] = 32'h01000100; 
			DATA_CONST_MEM[13] = 32'h00900090; 
			DATA_CONST_MEM[14] = 32'h00800080; 
			DATA_CONST_MEM[15] = 32'hAAAAAAAA; 
			DATA_CONST_MEM[16] = 32'hBBBBBBBB; 
			DATA_CONST_MEM[17] = 32'hAAAABBBB; 
