...
module ARM(
    ...
    assign PC_IN_Src = Mispredicted === 1'b1;
    assign PC_IN = (PC_IN_Src == 1'b1) ? ((PCWriteLDRW == 1'b1) ? ResultW : ((PCSrcE == 1'b0) ? PCPlus4E : ALUResultE)) : ((PrPCSrcF == 1'b1) ? PrALUResultF : PCPlus4F);
