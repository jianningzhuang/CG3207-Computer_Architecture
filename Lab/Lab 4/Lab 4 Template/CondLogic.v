...
module CondLogic(
    ...
    always @ (posedge CLK)
    begin
        N <= ((FlagW[1] == 1'b1) & (CondEx == 1'b1)) ? ALUFlags[3] : N;
        Z <= ((FlagW[1] == 1'b1) & (CondEx == 1'b1)) ? ALUFlags[2] : Z;
        C <= ((FlagW[0] == 1'b1) & (CondEx == 1'b1)) ? ALUFlags[1] : C;
        V <= ((FlagW[0] == 1'b1) & (CondEx == 1'b1)) ? ALUFlags[0] : V;
    end
    
    
    assign PCSrc = (PCS & CondEx);
    assign PCWriteLDR = (PCWLDR & CondEx);
